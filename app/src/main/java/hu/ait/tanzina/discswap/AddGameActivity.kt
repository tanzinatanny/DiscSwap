...
class AddGameActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val COLLECTION_KEY = "games"
    }
    ...
    private fun requestNeededPermission() {
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                Toast.makeText(this,
                    "Required for camera", Toast.LENGTH_SHORT).show()
            }
    ...
    private fun uploadPost(imageUrl: String = "") {
        ...
        var postsCollection =
            FirebaseFirestore.getInstance().collection(COLLECTION_KEY).add(post).addOnSuccessListener {

            Toast.makeText(this@AddGameActivity,
                R.string.game_added, Toast.LENGTH_LONG).show()
